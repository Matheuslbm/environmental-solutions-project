...
export const HOME_CONTENT = {
  ...
  galleryImages: [
    // URLs temporárias. Depois você troca pelos caminhos reais das imagens
    { id: 1, src: '/images/galeria-1.jpg', alt: 'Tanques de aço inox' },
    { id: 2, src: '/images/galeria-2.jpg', alt: 'Tratamento de água' },
    { id: 3, src: '/images/galeria-3.jpg', alt: 'Estação compacta' },
    { id: 4, src: '/images/galeria-4.jpg', alt: 'Vista aérea da estação' },
  ]
};
